...
{ 
  ...
  /**
   ...
   POST: Comparador de igualdad entre reales por aproximacié«?
         de un EPSILON fijado localmente.
   Devuelve cierto si y solo si x = y +- EPSILON
   DONDE: EPSILON = <<error de precisié«?>>
   POST: Devuelve cierto si y solo si x estï¿? en el 
  ...
  /**
   ...
   la posicié«? del que sea mayor de los dos valores.
   valorA >= valorB  --> posA
   eoc               --> posB
   */ 
  ...
  /*
   * aleatorio (n : int) : int
   * POST: Genera un né·ero aleatorio en el rango [0, |n-1|] 
   */       
   ...
   * POST: Genera un né·ero aleatorio en el rango [a, b] 
   */       
  ...
  /*
   ...
   PRE: cierto
   POST: resultado es la parte decimal del né·ero real <x>
   */
  ...
  /* 
   esperar1segundo ()
   EFECTO: Pausa la ejecucié«? durante un segundo.
   */
  ...
  /* 
   espera (segundos : int)
   EFECTO: Pausa la ejecucié«? durante <segundos>.
   */
  ...
  /* 
   ...
   POST: Determina si <s1> es lexicogré†˜icamente menor que <s2>.
   */
