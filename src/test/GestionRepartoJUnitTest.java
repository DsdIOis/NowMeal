...
//	
	 ...
	 *  
	 * <p>Comprueba la inicializaci髇 de los atributos.</p>
	 *  
	 ...
	 * 
	 * <p>Presupone que el m閠odo add de GestionLocalReparto funciona bien.</p>
	 * 
	 ...
	 * y los m閠odos de GestorReparto:
	 * constructor y addTransporteLocalidad.</p>
	 * 
	 * <p>Presupone que el m閠odo asignarPedido de GestionRepartoLocal funciona bien.</p>
	 *  
	 ...
	 * controlando el n鷐ero de transportes disponibles y el de pedidos en espera.</p>
	 */
	@Test
	...
	* <p>Utiliza los constructores de Moto, FurgonetaPropia y Pedido,
	 ...
	 * 
	 * <p>Presupone que el m閠odo notificarEntregaPedido de GestorRepartoLocal funciona bien.</p>
	 * 
	 * <p>Se crean transportes y se asignan a distintas localidades. 
	 * Se asignan pedidos para motos y furgonetas en distintas localidades
	 * y se notifica la entrega de dichos pedidos
	 * controlando el n鷐ero de transportes disponibles y el de 
